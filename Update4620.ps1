...
Write-Host "Downloading Kiosk Client 4.6.2.0"
DownloadFile "https://bcyclepublic.blob.core.windows.net/kiosk/KioskClient4620.zip" "C:\Software\KioskClient4620.zip"
...
cmd /c "C:\Tools\7za.exe" x -y C:\Software\KioskClient4620.zip -oC:\B-cycle
Start-Sleep -s 4
